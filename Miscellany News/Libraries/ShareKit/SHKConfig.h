...
#define SHKMyAppName			@"Miscellany News"
#define SHKMyAppURL				@"http://www.miscellanynews.com"
...
#define SHKFacebookKey				@"211537185571796"
#define SHKFacebookSecret			@"2a09301436163a9c3fa8ce87f907878a"
 ...
 */
#define SHKTwitterConsumerKey		@"q0Y94oiR1HjO2t3T4g9pwA"
#define SHKTwitterSecret			@"oRckNL1tCbm5LyyLPWaYkYwk9LKHswqVsYAxVC0"
#define SHKTwitterCallbackUrl		@"http://www.miscellanynews.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
